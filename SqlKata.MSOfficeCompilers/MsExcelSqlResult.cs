...
{
    internal class MsExcelSqlResult : SqlKata.SqlResult
    {
        public MsExcelSqlResult() { }
        public MsExcelSqlResult(SqlResult ctx)
        {
            ...
            foreach(var bind in NamedBindings)
            {
                if (bind.Value is string s)
                {
                    ValueRegex.
                }
            }
